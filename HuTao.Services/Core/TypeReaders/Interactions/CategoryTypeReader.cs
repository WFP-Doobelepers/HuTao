...
public class CategoryTypeReader : EntityTypeReader<ModerationCategory>
{
    ...
    protected override EmbedBuilder EntityViewer(ModerationCategory? entity) => throw new NotImplementedException();

    protected override string Id(ModerationCategory? entity) => throw new NotImplementedException();
