...
public class CategoryTypeReader : EntityTypeReader<ModerationCategory>
{
        ...
        IInteractionContext context, string option, IServiceProvider services)
    {
        ...
        if (string.IsNullOrEmpty(option)
            ...
            || option.Equals(nameof(ModerationCategory.None), StringComparison.OrdinalIgnoreCase))
        {
        ...
        if (option.Equals(nameof(ModerationCategory.All), StringComparison.OrdinalIgnoreCase))
