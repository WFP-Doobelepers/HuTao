...
{
    public partial class AddEmbedDetails : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProxyIconUrl = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StickyMessage_Guilds_GuildId",
                        column: x => x.GuildId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Embed_StickyMessageId",
                table: "Embed",
                column: "StickyMessageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attachment_StickyMessageId",
                table: "Attachment",
                column: "StickyMessageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StickyMessage_GuildId",
                table: "StickyMessage",
                column: "GuildId");

            migrationBuilder.AddForeignKey(
                name: "FK_Attachment_StickyMessage_StickyMessageId",
                table: "Attachment",
                column: "StickyMessageId",
                principalTable: "StickyMessage",
                principalColumn: "Id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Embed_StickyMessage_StickyMessageId",
                table: "Embed",
                column: "StickyMessageId",
                principalTable: "StickyMessage",
                principalColumn: "Id");
