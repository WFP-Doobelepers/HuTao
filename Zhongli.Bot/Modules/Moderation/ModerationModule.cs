...
namespace Zhongli.Bot.Modules.Moderation
{
    ...
    public class ModerationModule : ModuleBase
    {
        ...
        {
            var (action, userEntity) = await CreateReprimandAction(user, Reprimand.Warning, ModerationActionType.Added, reason);
        ...
        {
            var (action, userEntity) = await CreateReprimandAction(user, Reprimand.Ban, ModerationActionType.Added, reason);
        ...
        {
            var (action, userEntity) = await CreateReprimandAction(user, Reprimand.Kick, ModerationActionType.Added, reason);
        ...
        public async Task MuteAsync(IGuildUser user, TimeSpan? length = null, [Remainder] string? reason = null)
        {
            ...
            var (action, userEntity) = await CreateReprimandAction(user, Reprimand.Mute, ModerationActionType.Added, reason);
        ...
        private async Task<(ReprimandAction, GuildUserEntity)> CreateReprimandAction(IGuildUser user, Reprimand reprimand,
